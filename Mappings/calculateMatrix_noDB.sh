...
python updateMatrix.py --file_matrix out/matrix-eus-30DB.tab --file_lexicon data/wn-cldr-eus.tab --new_field_name EOWN-cldr
...
python updateMatrix.py --file_matrix out/matrix-eng-30DB.tab --file_lexicon data/wn-cldr-eng.tab --new_field_name EOWN-cldr
...
python updateMatrix.py --file_matrix out/matrix-spa-30DB.tab --file_lexicon data/wn-cldr-spa.tab --new_field_name EOWN-cldr
...
python updateMatrix.py --file_matrix out/matrix-cat-30DB.tab --file_lexicon data/wn-cldr-cat.tab --new_field_name EOWN-cldr
...
python updateMatrix.py --file_matrix out/matrix-glg-30DB.tab --file_lexicon data/wn-cldr-glg.tab --new_field_name EOWN-cldr
...
python updateMatrix.py --file_matrix out/matrix-por-30DB.tab --file_lexicon data/wn-cldr-por.tab --new_field_name EOWN-cldr
