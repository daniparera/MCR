...
echo Create Matrix
python3 createMatrix.py --host adimen.si.ehu.es --user user --pwd password --db database
...
python3 extractMatrixtoMCR.py --file_matrix out/matrix-eus-30.tab --stats_info

echo Extract information from Catalan matrix
python3 extractMatrixtoMCR.py --file_matrix out/matrix-cat-30.tab --stats_info --valid_list revisats

echo Extract information from Spanish matrix
python3 extractMatrixtoMCR.py --file_matrix out/matrix-spa-30.tab --stats_info --valid_list fase1

echo Extract information from Galician matrix
python3 extractMatrixtoMCR.py --file_matrix out/matrix-glg-30.tab --stats_info

echo Extract information from English matrix
python3 extractMatrixtoMCR.py --file_matrix out/matrix-eng-30.tab --stats_info

echo Extract information from Portuguese matrix
python3 extractMatrixtoMCR.py --file_matrix out/matrix-por-30.tab --stats_info
