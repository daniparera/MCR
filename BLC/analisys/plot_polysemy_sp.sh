...
echo "
  $3 set term png
  $3 set output 'polysemy_$1-$2-Cls.png'
  set datafile separator ','
  set title 'Polysemy BLC Class comparison - $2 $1'
...
echo "
  $3 set term png
  $3 set output 'polysemy_$1-$2-R.png'
  set datafile separator ','
  set title 'Polysemy BLC R comparison - $2 $1'
  set key autotitle columnhead outside
  set xtics rotate by -60
  set grid
...
echo "
  $3 set term png
  $3 set output 'polysemy_$1-$2-Cls_div_R.png'
  set datafile separator ','
  set title 'Polysemy BLC Cls/R comparison - $2 $1'
  set key autotitle columnhead outside
  set xtics rotate by -60
  set grid
